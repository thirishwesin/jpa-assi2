...
<form action="${save }" class="form" method="post">
	...
	<input type="date" value="${registrations.reg_date}" name="regdate" class="form-control col-6" required="required" />
	<label>Paid Amount</label>
	<input type="number" value="${registrations.paid_amt}" name="amt" class="form-control col-6" required="required" placeholder="Enter  Paid Amount"/>
